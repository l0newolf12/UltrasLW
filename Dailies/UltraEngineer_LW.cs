/*
name: Ultra Engineer LW
description: Four-player CoreLoneWolf Army script for Ultra Engineer.
tags: ultra, engineer, army, corelonewolf
*/
...
public class UltraEngineer_LW
{
    ...
    private const string LogPrefix = "Ultra Engineer LW";
    private const string SyncFileName = "UltraEngineer_LW.sync";
    ...
    public string OptionsStorage = "UltraEngineer_LW";
    ...
    private FightResult Fight(ClassPreset preset, int fightAttempt)
    {
        ...
        while (!Bot.ShouldExit)
        {
            ...
            if (!Bot.Player.Alive)
            {
                ...
                if (
                    LoneWolf.IsMonsterAlive(MainBossMapId)
            ...
            int targetMapId = LoneWolf.IsMonsterAlive(FirstTargetMapId)
                ? FirstTargetMapId
                : LoneWolf.IsMonsterAlive(SecondTargetMapId)
                    ? SecondTargetMapId
                    : MainBossMapId;
    ...
    private bool IsInSafeRoom() =>
        string.Equals(Bot.Player.Cell, SafeCell, System.StringComparison.OrdinalIgnoreCase);
